<p align="center">
  <picture>
    ...
    <img alt="J-CMS" src="src/main/webapp/images/logo-header.png" width="360">
  </picture>
</p>
...
<p align="center">
  <img alt="A J-CMS storefront and the built-in analytics console it ships with" src="docs/assets/j-cms-platform.png" width="820">
</p>
...
J-CMS works from day one, and each role can get straight to work:
...
Apache License 2.0 — see [LICENSE.txt](LICENSE.txt). Copyright 2023–2026 J-CMS Maintainers
