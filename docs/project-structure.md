...
# prettier-ignore
description: J-CMS frontend and backend details
---

J-CMS is driven by a custom web framework which facilitates dynamic pages, layouts, components called widgets, preferences, user roles and groups.
