...
| Bounce/complaint feedback | Provider-side (MailChimp dashboard, or SES/SendGrid/etc. webhooks if you adopt one) | Not currently surfaced inside J-CMS for the direct-SMTP path — this is an external tool you'd check on the provider's own dashboard |
