// ---------------------------------------------------------------------------
// j-cms — Azure infrastructure (Milestone #4 Phase 2)
//
...
param workloadName string = 'jcms'

@description('PostgreSQL administrator login.')
param postgresAdministratorLogin string = 'jcmsadmin'
...
param containerImage string = 'j-cms:latest'
