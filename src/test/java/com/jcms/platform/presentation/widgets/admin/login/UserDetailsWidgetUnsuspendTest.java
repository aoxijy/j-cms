...
class UserDetailsWidgetUnsuspendTest extends WidgetBase {
  ...
  void elevatedRestoreFilesARequestInsteadOfCallingUserRepositoryDirectly() throws Exception {
    ...
    try (MockedStatic<LoadUserCommand> loadCmd = mockStatic(LoadUserCommand.class);
      ...
      com.jcms.platform.domain.model.Role adminRole = new com.jcms.platform.domain.model.Role();
      adminRole.setId(4);
  ...
  void denyUnsuspendIsDispatchedThroughTheGetActionPathWithNoStepUp() throws Exception {
    ...
    com.jcms.platform.domain.model.login.UnsuspendRequest request =
        new com.jcms.platform.domain.model.login.UnsuspendRequest();
    request.setId(42L);
  ...
  private static com.jcms.platform.domain.model.Role roleWithLevel(int level) {
    com.jcms.platform.domain.model.Role role = new com.jcms.platform.domain.model.Role();
    role.setId(1);
    role.setLevel(level);
