...
class DomainModelTest {
  ...
  void testSettersAndGetters() {
    ...
    complexClasses.add("com.jcms.platform.domain.model.ecommerce.ProductSku");
    ...
    complexClasses.add("com.jcms.platform.domain.model.webhooks.WebhookSubscription");
    ...
    complexClasses.add("com.jcms.platform.domain.model.integrations.IntegrationDefinition");
    complexClasses.add("com.jcms.platform.domain.model.integrations.CredentialField");

    // Test getters and setters for the domain model
    Class<?>[] beanClasses = ClassPathUtils.findClassesIn("com.jcms.platform.domain.model");
