...
package com.jcms.platform.application.http;
...
import com.jcms.platform.provided.net.ConnectAddressPin;
 ...
 * standalone servlet (see {@code com.jcms.platform.provided.net.ConnectAddressPinResolverTest}
 ...
 * {@code target/j-cms-ssrf-pin-resolver.jar} on the test classpath -- runs unmodified.
 *
...
class HttpGetCommandExecuteUserUrlPinTest {
  ...
  void executeUserUrlPinsTheValidatedAddressAndReachesTheTrap() throws Exception {
    ...
    String fakeHost = "executeuserurl-pin-" + System.nanoTime() + ".jcms-ssrf-pin-test.example.com";
  ...
  void executeUserUrlNeverConnectsWhenValidationRejectsTheUrl() {
    String fakeHost = "executeuserurl-blocked-" + System.nanoTime() + ".jcms-ssrf-pin-test.example.com";
  ...
  void plainExecuteHonorsAPreExistingPinWithoutManagingItItself() throws Exception {
    ...
    int port = startTrapServer();
    String fakeHost = "execute-plain-" + System.nanoTime() + ".jcms-ssrf-pin-test.example.com";
    String url = "http://" + fakeHost + ":" + port + "/";
