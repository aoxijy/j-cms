...
import com.jcms.platform.application.http.HttpPostCommand;
import com.jcms.platform.domain.events.cms.UserSignedUpEvent;
import com.jcms.platform.domain.model.User;
import com.jcms.platform.domain.model.webhooks.WebhookDelivery;
...
import com.jcms.platform.infrastructure.persistence.webhooks.WebhookDeliveryRepository;
import com.jcms.platform.infrastructure.persistence.webhooks.WebhookSubscriptionRepository;
import com.jcms.platform.infrastructure.workflow.WebhookTask;
...
class WebhookTaskTest {
  ...
  void matchingEnabledSubscriptionGetsARealSignedDeliveryDisabledAndNonMatchingDoNot() throws Exception {
    long matching = seedSubscription("https://hooks.example.com/jcms", "trap-secret", "user-signed-up", true);
    ...
    assertEquals("https://hooks.example.com/jcms", urlCaptor.getValue());
