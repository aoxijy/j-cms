...
package com.jcms.platform.application.filesystem;
...
public class FileSystemCommand {
  ...
  public static String getFileServerConfigPath() {
    ...
    if (StringUtils.isBlank(serverConfigPath)) {
      ...
      LOG.info("HINT: INSERT INTO site_properties (property_label, property_name, property_value) VALUES ('Configuration path', 'system.configpath', '/opt/jcms/config')");
      return null;
    }
  ...
  public static String getFileServerRootPath() {
    ...
    if (StringUtils.isBlank(serverRootPath)) {
      ...
      LOG.info("HINT: INSERT INTO site_properties (property_label, property_name, property_value) VALUES ('File server path', 'system.filepath', '/opt/jcms/files')");
      return null;
    }
