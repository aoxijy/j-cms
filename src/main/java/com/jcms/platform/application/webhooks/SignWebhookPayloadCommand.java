 ...
 * the {@code X-J-CMS-Signature: sha256=<hex>} header the receiver uses to verify the request
...
public class SignWebhookPayloadCommand {
  ...
  /** The full header value, e.g. {@code "sha256=<hex>"} -- ready to set on X-J-CMS-Signature. */
  public static final String HEADER_NAME = "X-J-CMS-Signature";
