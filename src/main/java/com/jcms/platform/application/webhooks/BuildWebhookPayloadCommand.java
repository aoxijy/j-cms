...
import com.jcms.platform.domain.events.mailinglists.MailingListMemberCreatedEvent;
import com.jcms.platform.domain.events.mailinglists.MailingListMemberDeletedEvent;
import com.jcms.platform.domain.events.mailinglists.MailingListMemberUpdatedEvent;
...
import com.jcms.platform.domain.events.cms.BlogPostPublishedEvent;
import com.jcms.platform.domain.events.cms.CalendarEventRemovedEvent;
import com.jcms.platform.domain.events.cms.CalendarEventRescheduledEvent;
import com.jcms.platform.domain.events.cms.CalendarEventScheduledEvent;
import com.jcms.platform.domain.events.cms.FormSubmittedEvent;
import com.jcms.platform.domain.events.cms.UnsuspendRequestedEvent;
import com.jcms.platform.domain.events.cms.UserAccountRestoredEvent;
import com.jcms.platform.domain.events.cms.UserInvitedEvent;
import com.jcms.platform.domain.events.cms.UserPasswordResetEvent;
import com.jcms.platform.domain.events.cms.UserRegisteredEvent;
import com.jcms.platform.domain.events.cms.UserSignedUpEvent;
import com.jcms.platform.domain.events.cms.WebPagePublishedEvent;
import com.jcms.platform.domain.events.cms.WebPageUpdatedEvent;
import com.jcms.platform.domain.events.ecommerce.OrderSubmittedEvent;
import com.jcms.platform.domain.model.User;
import com.jcms.platform.domain.model.cms.CalendarEvent;
import com.jcms.platform.domain.model.cms.FormData;
...
public class BuildWebhookPayloadCommand {
  ...
  private static void putWebPage(Map<String, Object> data,
      com.jcms.platform.domain.model.cms.WebPage webPage, String title) {
    if (webPage == null) {
      return;
    }
