  ...
  private static boolean isPinResolverAvailable() {
    try {
      ...
      LOG.warn("SSRF connect-time DNS pinning (issue #760) is unavailable: "
          + "com.jcms.platform.provided.net.ConnectAddressPin was not found on this JVM's "
          ...
          + "image must also place target/j-cms-ssrf-pin-resolver.jar on the container's "
