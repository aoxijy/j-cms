...
public class MailingListMemberRepository {
   ...
   *     control by clicking the link {@link com.jcms.platform.application.mailinglists.MailingListConfirmationCommand}
   ...
   * name/email search {@link com.jcms.platform.infrastructure.persistence.mailinglists.EmailRepository}
