...
package com.jcms.platform.infrastructure.scheduler;

import com.jcms.platform.domain.events.Event;
import com.jcms.platform.infrastructure.database.DataSource;
import com.jcms.platform.infrastructure.instance.InstanceManager;
import com.jcms.platform.infrastructure.scheduler.admin.CapabilityGrantExpirationJob;
import com.jcms.platform.infrastructure.scheduler.admin.DatasetsDownloadAndSyncJob;
import com.jcms.platform.infrastructure.scheduler.audit.AuditLogIntegrityJob;
import com.jcms.platform.infrastructure.scheduler.audit.AuditLogRetentionJob;
import com.jcms.platform.infrastructure.scheduler.cms.FormDataRetentionJob;
import com.jcms.platform.infrastructure.scheduler.cms.FormSubmissionFailureRetentionJob;
import com.jcms.platform.infrastructure.scheduler.cms.FunnelEventRetentionJob;
import com.jcms.platform.infrastructure.scheduler.cms.LoadSystemFilesJob;
import com.jcms.platform.infrastructure.scheduler.cms.RecordWebPageHitJob;
import com.jcms.platform.infrastructure.scheduler.cms.SearchAnalyticsCleanupJob;
import com.jcms.platform.infrastructure.scheduler.cms.SessionsPiiScrubJob;
import com.jcms.platform.infrastructure.scheduler.cms.SystemHealthCheckCleanupJob;
import com.jcms.platform.infrastructure.scheduler.cms.SystemHealthJob;
import com.jcms.platform.infrastructure.scheduler.cms.WebPageHitSnapshotJob;
import com.jcms.platform.infrastructure.scheduler.cms.WebPageHitsCleanupJob;
import com.jcms.platform.infrastructure.scheduler.cms.WebSearchCleanupJob;
import com.jcms.platform.infrastructure.scheduler.cms.WebVitalsAggregationJob;
import com.jcms.platform.infrastructure.scheduler.cms.WebVitalsCleanupJob;
import com.jcms.platform.infrastructure.scheduler.ecommerce.OrderManagementProcessNewOrders;
import com.jcms.platform.infrastructure.scheduler.ecommerce.OrderManagementProcessShippingUpdates;
import com.jcms.platform.infrastructure.scheduler.login.UserTokensCleanupJob;
import com.jcms.platform.infrastructure.scheduler.mailinglists.EmailClassificationJob;
import com.jcms.platform.infrastructure.scheduler.mailinglists.MailingListQuarantineJob;
import com.jcms.platform.infrastructure.scheduler.mailinglists.NewsletterQueueJob;
import com.jcms.platform.infrastructure.scheduler.medicine.ProcessMedicineSchedulesJob;
import com.jcms.platform.infrastructure.scheduler.socialmedia.InstagramMediaSnapshotJob;
