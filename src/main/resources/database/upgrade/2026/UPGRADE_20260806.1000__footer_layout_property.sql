    ...
    <section class="padding-top-20">
      <column class="small-12 medium-4 cell">
        ...
        <widget name="content" class="margin-top-15">
          <html><![CDATA[<p>J-CMS provides a self-hosted content platform for building secure websites, portals, and digital services.</p>]]></html>
        </widget>
        <widget name="button">
          <title>Learn more about J-CMS</title>
          <link>/about-us</link>
        </widget>
