...
INSERT INTO site_properties (property_label, property_name, property_value) VALUES ('Customizations path', 'system.customizations.filepath', '/opt/jcms/customization');
INSERT INTO site_properties (property_label, property_name, property_value) VALUES ('File server path', 'system.filepath', '/opt/jcms/files');
INSERT INTO site_properties (property_label, property_name, property_value) VALUES ('Configuration path', 'system.configpath', '/opt/jcms/config');
...
-- FROM '/opt/jcms/data/world_cities.csv' DELIMITER ',' CSV HEADER;
--
...
-- COPY zip_codes
-- FROM '/opt/jcms/data/zipcodes.csv' DELIMITER ',' CSV HEADER;
--
