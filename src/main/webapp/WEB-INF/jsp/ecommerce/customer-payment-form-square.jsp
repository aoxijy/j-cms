...
<jsp:useBean id="cart" class="com.jcms.platform.domain.model.ecommerce.Cart" scope="request"/>
<jsp:useBean id="customer" class="com.jcms.platform.domain.model.ecommerce.Customer" scope="request"/>
<jsp:useBean id="payment" class="com.jcms.platform.domain.model.ecommerce.Payment" scope="request"/>
