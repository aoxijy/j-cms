...
<jsp:useBean id="blockedIP" class="com.jcms.platform.domain.model.BlockedIP" scope="request"/>
...
<form method="post">
  ...
  <%-- Form Content --%>
  <label><fmt:message key="security.ipOrCidrBlock" bundle="${adminMessages}" /> <span class="required">*</span>
