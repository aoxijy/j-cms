      ...
      <tr>
        ...
        <td nowrap>
          ...
          <c:if test="${siteProperty.name eq 'mail.from_address'}">
            <p class="help-text" id="mailFromAddressHelpText">The address that appears in the "From" field of every email J-CMS sends -- form submissions, newsletters, and other notifications all go out from here. Must be an address your mail server or provider is actually authorized to send as; most providers (Microsoft 365, SendGrid, etc.) reject or bounce messages from an unrecognized From address. Example: noreply@yourdomain.com.</p>
          </c:if>
